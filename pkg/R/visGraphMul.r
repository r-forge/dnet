...
#'
#' \code{visGraphMul} is supposed to visualise the same graph but with multiple colorings according to input data matrix
#'
...
#' visGraphMul(g=subg, data=data, glayout=layout.fruchterman.reingold)

visGraphMul <- function (g, data, height=7, margin=rep(0.1,4), border.color="#EEEEEE", colormap=c("bwr","jet","gbr","wyr","br","yr","rainbow","wb"), ncolors=40, zlim=NULL, colorbar=T, colorbar.fraction=0.25, newpage=T, glayout=layout.fruchterman.reingold, mtext.side=3, mtext.adj=0,mtext.cex=1,mtext.font=2,mtext.col="black", ...)
{   
