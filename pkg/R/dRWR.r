...
#'
#' \code{dRWR} is supposed to implement Random Walk with Restart (RWR) to pre-compute affinity matrix for for nodes in the input graph with respect to the starting node (loop over every node in the graph)
#'
...
dRWR <- function(g, normalise=c("laplacian","row","column","none"), restart=0.75)
{
