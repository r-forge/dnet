...
#'
#' \code{eView} is supposed to view results of gene set enrichment analysis but for a specific sample. 
#'
...
eView <- function(eTerm, which_sample=1, top_num=10, sortBy=c("adjp","gadjp","ES","nES","pvalue","FWER","FDR","qvalue"), decreasing=NULL, details=F) 
{
