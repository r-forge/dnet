...
#'
#' \code{eGraphReorder} is reorder the multiple graph colorings within a sheet-shape rectangle grid
#'
...
#' @export
#' @seealso \code{\link{visGraphReorder}}
#' @include eGraphReorder.r
#' @examples
