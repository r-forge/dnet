...
#' @export
#' @seealso \code{\link{ePvalAggregate}}
#' @include ePvalAggregate.r
#' @examples
...
#' ap <- ePvalAggregate(pmatrix, method="orderStatistic")
#'
#' # 3) aggregate according to the Fisher's method
#' ap <- ePvalAggregate(pmatrix, method="fishers") 


ePvalAggregate <- function (pmatrix, method=c("orderStatistic", "fishers"), order=ncol(pmatrix)) 
{
