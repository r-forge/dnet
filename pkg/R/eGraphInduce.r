...
#' subg <- eGraphInduce(g, nodes_query, knn=0)
#'
#' # 4) produce the induced subgraph based on the nodes in query ane their immediate neighbours
#' subg <- eGraphInduce(g, nodes_query, knn=1)

eGraphInduce <- function(g, nodes_query, knn=0, remove.loops=T, largest.comp=T) 
{
