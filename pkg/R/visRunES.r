...
#' @note none
#' @export
#' @seealso \code{\link{eCal}}, \code{\link{eView}}
#' @include visRunES.r
#' @examples
#' #visRunES(eTerm, which_sample=1, which_term=1)

visRunES <- function(eTerm, which_sample=1, which_term="GO:0006281", weight=1, orientation=c('vertical','horizontal'), newpage=T) 
{
